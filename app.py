        ...
        if clientes_filtrados:
            ...
            if generate_report_pdf('report_template.html', report_data, report_path):
                ...
                if not send_email(email_subject, email_body, email_to, report_path):
                    return "Error al enviar correo del vendedor {vendedor_name}.", 500

            else:
                  return "Error al generar reporte del vendedor {vendedor_name}.", 500
    
    return "Reportes generados y enviados con éxito.", 200
